    ...
    return (
        <div className="container my-4">
            ...
            <div className="d-flex justify-content-center gap-2 mb-4 flex-wrap">
                ...
                <button
                    className={`btn ${filter === "1month" ? "btn-primary" : "btn-outline-primary"
                        }`}
                ...
                <button
                    className={`btn ${filter === "3months" ? "btn-primary" : "btn-outline-primary"
                        }`}
                ...
                <button
                    className={`btn ${filter === "6months" ? "btn-primary" : "btn-outline-primary"
                        }`}

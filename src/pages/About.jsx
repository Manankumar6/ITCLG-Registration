...
const About = () => {
  return (
    <div className='container' style={{height:"100vh"}}>
        ...
        <h5 className='text-danger'>About this course</h5>
        <p>Advance Diploma In Information Technology is a Diploma in Automation, Financial Accounting, Graphics, PC Fundamental, Office Automation, Desktop Publishing, Programming, PC Troubleshooting, and Web Designing. It is a diploma course divided into five main semesters. 1st part covers your Computerized Office Documentation, 2nd part covers Financial Accounting Program to learn how to maintain Accounting of Various Firms and LTD. CO, 3rd and 4th part covers developing Graphics and layouts for product illustrations, company logos, and websites. Graphics designing can use image-based designs involving photos, illustrations, logos and symbols, type-based designs, or a combination of both techniques. This course also provides you knowledge of Hardware where you can learn how to deal with your computer hardware problems.</p>

        <h5 className='text-danger'>More Instructions</h5>
        <ul>
            <li>Advance Diploma In Information Technology is a 15 months Diploma.</li>
            <li>Advance Diploma In Information Technology gives you job opening in many fields like data entry operator, sales executive, office administrator, graphic designer, photo editor, newspaper add designer, and accountant. After completion of the diploma, one can approach special career-oriented fields in computers.</li>
        </ul>
